...
- Se debe usar `$optimizar-contexto` al explorar repositorios, ejecutar herramientas verbosas o sostener tareas largas, sin reducir verificaciones ni evidencia.
