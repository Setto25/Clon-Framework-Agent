...
async def probar_endpoint(url_base: str, token: str) -> None:
    """Comprueba seguridad y contrato contra un endpoint ya disponible."""
...
async def ejecutar() -> None:
    """Inicia el servidor local y ejecuta el recorrido HTTP compartido."""
