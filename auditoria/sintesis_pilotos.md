...
| Media | Docker no esta instalado en el entorno de validacion MCP. | El `Dockerfile` y el lock existen, pero la imagen OCI no dispone aun de evidencia de build. | Construir y ejecutar la imagen en CI o en un host con Docker antes del despliegue remoto. |
